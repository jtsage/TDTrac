...
$DEFAULT_DATA = array(
	...
	"INSERT INTO `{$MYSQL_PREFIX}permissions` (`id`, `groupid`, `permid`, `permcan`) VALUES (1, 1, 'addshow', 1), (2, 1, 'editshow', 1), (3, 1, 'viewshow', 1), (4, 1, 'addbudget', 1), (5, 1, 'editbudget', 1), (6, 1, 'viewbudget', 1), (7, 1, 'addhours', 1), (8, 1, 'edithours', 1), (9, 1, 'viewhours', 1), (10, 1, 'adduser', 1), (11, 4, 'addshow', 0), (12, 4, 'editshow', 0), (13, 4, 'viewshow', 1), (14, 4, 'addbudget', 0), (15, 4, 'editbudget', 0), (16, 4, 'viewbudget', 1), (17, 4, 'addhours', 1), (18, 4, 'edithours', 0), (19, 4, 'viewhours', 1), (20, 4, 'adduser', 0);",
	...
	"INSERT INTO `{$MYSQL_PREFIX}todo` (`id`, `showid`, `due`, `assigned`, `dscr`, `priority`, `added`, `complete`) VALUES(1, 1, '2013-09-01 00:00:00', 1, 'Unexpired, Incomplete Task', 2, '2010-05-12 21:42:11', 0),(2, 1, '2010-05-12 00:00:00', 1, 'Expired, Completed Task', 2, '2010-05-13 20:17:53', 1),(3, 1, '2011-11-16 11:07:10', 0, 'Expired, Incomplete Task', 2, '2011-11-16 11:07:10', 0);"
	);
